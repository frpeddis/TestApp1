...
with st.container():
    ...
    if not data.empty and len(data) >= 5:
        ...
        st.markdown("<div class='custom-box'> <P><B>Riordina le pagine del tuo libro di Storia ! </B></P>👆 Trascina in alto i <span style='background-color: red; color: white; padding: 3px 6px; border-radius: 3px;'>segnalibri</span> più antichi, 👇 in basso i più recenti!</div>", unsafe_allow_html=True)
