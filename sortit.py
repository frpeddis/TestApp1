...
with st.container():
    ...
    if not data.empty and len(data) >= 5:
        ...
        st.markdown("<div class='custom-box'> <P>Riordina le pagine del tuo libro si Storia ! </P>👆 Trascina in alto i segnalibri più antichi, 👇 in basso i più recenti!</div>", unsafe_allow_html=True)
